    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center caption mt-60">
                <h5><?php if(isset($perukar_redux_demo['blog_subtitle'])){?>
                    <?php echo wp_specialchars_decode(esc_attr($perukar_redux_demo['blog_subtitle']));?>
                    <?php }else{?>
                    <?php echo esc_html__( 'Our Blog', 'perukar' ); } ?></h5>
                <h1><?php if(isset($perukar_redux_demo['blog_title'])){?>
                    <?php echo wp_specialchars_decode(esc_attr($perukar_redux_demo['blog_title']));?>
                    <?php }else{?>
                    <?php echo esc_html__( 'Latest News', 'perukar' ); } ?></h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-6">
                <div class="item mb-60">
                    ...
                    <div class="con"> 
                        <?php if ($cate_name !='')  { ?>
                        <span class="category">
                            <a href="<?php the_permalink();?>"><?php echo esc_html($cate_name);?></a>
                        </span>
                        <?php } ?>
