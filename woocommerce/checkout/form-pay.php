	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'perukar' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'perukar' ); ?></th>
			</tr>
		</thead>
		<tbody>
