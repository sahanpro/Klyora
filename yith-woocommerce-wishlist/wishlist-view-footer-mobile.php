		...
		<div class="wishlist-actions">
			<?php if ( $count && $show_update ) : ?>
				...
				<div class="yith_wcwl_wishlist_update">
					<input type="submit" class="<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ); ?>" name="update_wishlist" value="<?php esc_attr_e( 'Update', 'perukar' ); ?>"/>
				</div>
			<?php endif; ?>
			...
			<div class="yith_wcwl_footer_additional_action">
				<?php if ( $count && $show_ask_estimate_button ) : ?>
					...
					<a
						...
						<?php echo esc_attr( $additional_info || ! is_user_logged_in() ) ? 'data-rel="prettyPhoto[ask_an_estimate]"' : ''; ?>
					>
						<?php
						/**
