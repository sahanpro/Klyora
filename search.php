    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center caption mt-60">
                <h1><?php printf( esc_html__( 'Search Results for: %s', 'perukar' ), get_search_query() ); ?></h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="search-custom" >
                        <h4>
                            <?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'perukar' ) ;?>
                        </h4>
                        <?php get_search_form();  ?>
                    </div> 
                    <?php endif;?>
